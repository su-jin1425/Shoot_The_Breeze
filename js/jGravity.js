		...
		return this.each(function() {
		  ...
		  b2PairManager.prototype = {
			...
			AddBufferedPair: function(a, b) {
			  ...
			  if (c.IsBuffered() == false) {
				...
				this.m_pairBuffer[this.m_pairBufferCount].proxyId2 = c.proxyId2; ++this.m_pairBufferCount
			  }
			  c.ClearRemoved();
			...
			Commit: function() {
			  ...
			  for (a = 0; a < this.m_pairBufferCount; ++a) {
				...
				if (d.IsRemoved()) {
				  ...
				  this.m_pairBuffer[b].proxyId2 = d.proxyId2; ++b
				} else {
				  if (d.IsFinal() == false) {
			...
			AddPair: function(a, b) {
			  ...
			  this.m_hashTable[d] = f; ++this.m_pairCount;
			  return e
			},
			RemovePair: function(a, b) {
			  ...
			  while (e != b2Pair.b2_nullPair) {
				if (b2PairManager.Equals(this.m_pairs[e], a, b)) {
				  ...
				  h.userData = null;
				  h.status = 0;
				  this.m_freePair = g; --this.m_pairCount;
				  return i
				} else {
				  f = this.m_pairs[e];
				  e = f.next
		  ...
		  b2BroadPhase.prototype = {
				...
				while (l) {
				  if (e[k].IsLower()) {
					...
					if (h <= m.upperBounds[g]) {
					  this.IncrementOverlapCount(e[k].proxyId); --l
					}
				  }--k
				}
			  }
			...
			IncrementOverlapCount: function(a) {
			  ...
			  if (b.timeStamp < this.m_timeStamp) {
				...
				b.overlapCount = 2;
				this.m_queryResults[this.m_queryResultCount] = a; ++this.m_queryResultCount
			  }
			},
		  ...
		  b2Body.prototype = {
			...
			initialize: function(a, b) {
			  ...
			  for (c = 0; c < b2Settings.b2_maxShapesPerBody; ++c) {
				...
				this.m_center.y += e.mass * (d.localPosition.y + e.center.y); ++this.m_shapeCount
			  }
			  if (this.m_mass > 0) {
		  ...
		  b2World.prototype = {
			...
			DestroyBody: function(a) {
			  ...
			  a.m_flags |= b2Body.e_destroyFlag; --this.m_bodyCount;
			  a.m_prev = null;
			...
			CreateJoint: function(a) {
			  ...
			  this.m_jointList = b; ++this.m_jointCount;
			  b.m_node1.joint = b;
